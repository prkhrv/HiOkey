...
import 'package:hiokey_physician/page/home_page.dart';
import 'package:intl_phone_field/intl_phone_field.dart';
// import 'package:pf_patient/Controllers/login_controller.dart';
// import 'package:pf_patient/Pages/auth/otp_page.dart';
// import 'package:pf_patient/Pages/auth/patient_signup.dart';
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Row(
                        children:  const [
                          SizedBox(width: 15),
                          Text("Physician Login",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),)
                        ],
                      ),
                    ),
                    ...
                    ElevatedButton.icon(onPressed: () async{
                        ...
                        var res = await authController.loginPhysician(phone,name);
                        if(res["success"] == true){

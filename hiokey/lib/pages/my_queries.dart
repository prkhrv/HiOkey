...
import 'package:hiokey/controllers/query_controller.dart';
                      ...
                      ExpandablePanel(
                          ...
                          expanded: prescriptions[index]["answer"] == null ? Container():Padding(
                            ...
                            child: Column(
                              ...
                              children:  [
                                Text("Physician Response :",style: TextStyle(fontWeight: FontWeight.bold)),
                                const SizedBox(height: defaultPadding),
                                Text("${prescriptions[index]["answer"]}"),
                                const SizedBox(height: defaultPadding),
                                Text("Add Rating :",style: TextStyle(fontWeight: FontWeight.bold)),
                                RatingBar.builder(
                                  initialRating: prescriptions[index]["rating"].toDouble(),
                                  minRating: 0,
                                  ...
                                  onRatingUpdate: (rating) {
                                    queryController.updateRating(index, rating);
                                  },
                                ),
                                const SizedBox(height: defaultPadding)
                              ],
